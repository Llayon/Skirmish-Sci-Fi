...
describe('AoE Parity: Grenade Clusters', () => {
    ...
    it('Scenario: Grenade hits a cluster of 3 enemies with accuracy checks', () => {
        const attacker = createParticipant('Hero', { x: 8, y: 8 }, 'player'); 
        const t1 = createParticipant('Enemy1', { x: 10, y: 10 }, 'enemy'); 
        const t2 = createParticipant('Enemy2', { x: 11, y: 10 }, 'enemy'); 
        const t3 = createParticipant('Enemy3', { x: 10, y: 11 }, 'enemy'); 
