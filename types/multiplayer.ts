...
import type {
  BattleAction,
  EngineBattleState,
} from "../services/engine/battle/types";
...
export type MultiplayerMessage =
  ...
  | {
      ...
      payload: {
        battleId?: string;
        clientActionId: string;
        reason: "invalid_action" | "battle_id_mismatch" | "resyncing";
      };
    }
  | {
      type: "ENGINE_SYNC_REQUEST";
      payload: { battleId: string; lastReceivedSeq: number };
    }
  | {
