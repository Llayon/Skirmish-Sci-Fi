...
const CharacterStatus: React.FC<CharacterStatusProps> = ({ participant }) => {
  ...
  return (
    <div className='bg-surface-raised/80 backdrop-blur-sm p-3 rounded-lg border border-border/50 w-full animate-slide-up shadow-lg'>
      <div className='text-center'>
        ...
        <div className='flex items-center justify-center gap-2 mt-3'>
          <span className='text-xs text-text-muted uppercase font-bold'>Actions:</span>
      ...
      <div className='mt-3 pt-3 border-t border-border/50'>
        <h5 className='text-xs text-text-muted uppercase font-bold mb-2 text-left'>Weapons</h5>
